...
# Destinatários
$notificationEmails = @("italo.silva@destinatario.com")  # <--- AQUI vão os DESTINATÁRIOS
$senderEmail = "t.italo.silva@remetente.com"           # <--- E-mail configurado no App Registration como remetente autorizado
